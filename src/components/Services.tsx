    ...
    <section ref={ref} id="services" className="section-x section-y border-t hairline">
      ...
      <div className="mb-24 sm:mb-32">
        ...
        <div className="grid grid-cols-12 gap-4 sm:gap-5">
          {domains.map((d, i) => {
            const DIcon = d.icon;
            // Bento layout: top row 7/5, bottom row 5/7 — fills the grid completely
            const bento = [
              'col-span-12 md:col-span-7 min-h-[320px] md:min-h-[360px]',
              'col-span-12 md:col-span-5 min-h-[260px] md:min-h-[360px]',
              'col-span-12 md:col-span-5 min-h-[260px] md:min-h-[360px]',
              'col-span-12 md:col-span-7 min-h-[260px] md:min-h-[360px]',
            ];
